...
class TestEnterToConstructor:
    ...
    def test_enter_to_constructor_from_personal_account(self, driver):
        ...
        h1 = WebDriverWait(driver, 5).until(EC.visibility_of_element_located(TestLocators.ASSEMBLE_BURGER))

        assert h1.text == "Соберите бургер"

    def test_enter_to_constructor_from_personal_account_via_logo(self, driver):
        driver.get(TestUrls.MAIN_URL)
